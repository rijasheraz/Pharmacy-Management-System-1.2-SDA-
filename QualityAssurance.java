...
public class QualityAssurance extends JFrame implements ActionListener{
    ...
    public QualityAssurance()
    {
        ...
        back.setSize(100, 30);
        back.setLocation(220, 470);
        back.addActionListener(this);
        c.add(back);
        
        tout = new JTextArea();
        tout.setFont(new Font("Arial", Font.PLAIN, 15));
        tout.setSize(330, 290);
        ...
        res = new JLabel("");
        res.setFont(new Font("Time New Roman", Font.PLAIN, 19));
        res.setSize(700, 30);
        res.setLocation(100,500);
        c.add(res);
  // Set background color for the container
        c.setBackground(new Color(122,186,120)); // Example: Light blue color
