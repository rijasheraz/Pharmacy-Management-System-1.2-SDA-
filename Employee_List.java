...
public class Employee_List extends JFrame {
   ...
   // Variables declaration - do not modify                     
    ...
    public Employee_List() {
        ...
        getContentPane().setBackground(new Color(122, 186, 120));  // Change background color here
        setResizable(false);
        initComponents();
        ShowData();
    }
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jButtonBack, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE))
    ...
    private void jButtonBackActionPerformed(java.awt.event.ActionEvent evt) {
        new Menu().setVisible(true); // Open the home page
